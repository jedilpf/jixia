...
export const themes: Record<ThemeId, ThemeColors> = {
  'ancient-gold': {
    ...
    name: 'Ancient Gold',
    nameZh: '古韵金辉',
    description: '古典中国风，以金红色为主调，搭配深褐色背景，营造庄重典雅的氛围',
    colors: {
      primary: '#d4a520',
      primaryLight: '#f8e6be',
      primaryDark: '#8b6914',
      secondary: '#7d3d23',
      secondaryLight: '#9a4126',
      accent: '#d46b42',
      accentLight: '#f0c36e',
      background: '#1b0c0a',
      backgroundLight: '#2a0e0a',
      backgroundDark: '#120604',
      surface: '#2a0e0a',
      surfaceLight: '#341410',
      surfaceDark: '#160a08',
      text: '#f8e6be',
      textMuted: '#d1b185',
      textLight: '#fff7eb',
      border: 'rgba(210, 150, 72, 0.35)',
      borderLight: 'rgba(240, 195, 110, 0.55)',
      success: '#2d5a3d',
      warning: '#d29648',
      danger: '#d46b42',
      info: '#7d3d23',
    ...
    gradients: {
      ...
      secondary: 'linear-gradient(135deg, #7d3d23 0%, #341410 100%)',
      accent: 'linear-gradient(135deg, #d46b42 0%, #7d3d23 100%)',
      surface: 'linear-gradient(180deg, #2a0e0a 0%, #160a08 100%)',
      card: 'linear-gradient(180deg, #341410 0%, #160a08 100%)',
      hero: 'linear-gradient(180deg, #7d3d23 0%, #341410 100%)',
      enemy: 'linear-gradient(180deg, #5a1c14 0%, #2a0e0a 100%)',
    },
    shadows: {
      primary: '0 0 20px rgba(212, 165, 32, 0.35)',
      glow: '0 0 30px rgba(212, 165, 32, 0.55)',
