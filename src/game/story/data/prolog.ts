...
案上烛火摇曳，将那封泛黄信函映得忽明忽暗。信笺已然陈旧，边角微卷，墨迹淡褪。唯有那枚朱红印章，依旧鲜艳如血——
那是父亲至交之印，亦是汝此生最大之谜。
父亲临终那夜，气息如游丝。
彼紧握汝手，浑浊双眸中闪过一丝光亮：
...
求一个明白。`,
  ...
  // ====== 序章·稷下城门 ======
  {
    ...
    content: `黎明天色，薄雾四合。
稷下城郭隐于轻纱之内，若隐若现。
远处晨钟乍响，声彻云霄，在城郭间回荡不绝。城门方启，人流如涌——有早起的商贾，有述职的官吏。而更多的是自四方跋涉而来的求道者。
稷下学宫之旗于晨风中猎猎翻卷。旗上所绣，非一家一派之徽记，乃是两个古朴苍劲的大字——
「百家。
人潮之中，汝足步缓缓而前。怀中那封泛黄的信函，被攥得愈紧。
此信，汝知之——乃是改变命运之契机，亦是背负使命之始。`,
...
穿过学宫外门，汝步入一座宽敞殿宇。
殿内陈设简朴，长案依次而列。案后各坐登记官一人，正为新生办理入学之事。
正中长案之后，一位身着素色袍服的登记官引起了汝之注意。其身后高悬一匾，上书四个苍劲大字——
「有教无类」`,
  ...
  // ====== 序章·入学登记 ======
  {
    ...
    choices: [
      {
        id: 'reg_direct',
        text: '💬 直言：「在下孟舆，一介布衣。久闻稷下广纳百家的盛名，特来求学。不为扬名，只为明白一事——这天下，何为正道？"',
        effects: {
          stats: { courage: 3 },
      ...
      {
        id: 'reg_graceful',
        text: '🤝 婉言：「小生孟舆，来自临淄。家父生前常言，稷下学宫乃天下学子向往之地。吾虽不才，亦欲继承父志，来此求学问道。"',
        effects: {
          stats: { charm: 3 },
...
虚空中，汝发现自己置身于一片燃烧之废墟。
此曾是一座村庄——或者说，曾经是。
火焰吞噬茅屋，浓烟蔽日。哭喊声、惨叫声、兵刃相交声交织于耳。
汝见一群衣衫褴褛之平民正在逃窜。他们扶老携幼，脸上写满恐惧与绝望。
一道声音在汝耳畔响起。
...
汝立于悬崖之畔。
眼前乃一片无垠云海。云涛翻滚，如浪相叠。
远处，云海之下隐约可见一座小村落。那乃是汝梦中无数次见及之处——
故乡。
风自崖下吹来，带着云雾之润泽。
...
「吾要学贯百家，明白天下至理！
云海中，画面一转——汝见己立于学宫之巅，著作等身。天下学子皆来求学，问道解惑。
老者微微一笑。
「求知若渴，善莫大焉。
「然知识无涯，汝可备足以一生追寻否？」`,
    nextNode: 'prolog_0_mind_complete',
...
「吾想归家……
「那些简单快乐之日，才是吾所真正想要之。
云海中，画面一转——汝见己立于故乡小院之中。祖父坐于树下，汝侍于侧，聆听彼讲故事。炊烟袅袅，饭菜飘香。
老者轻叹。
「返璞归真，此亦道也。
「然汝可确定，能放下一切否？」`,
    nextNode: 'prolog_0_mind_complete',
