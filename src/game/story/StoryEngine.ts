...
export class StoryEngine {
  ...
  private loadNodes() {
    const storyNodes = [...PROLOG_NODES, ...CHAPTER_MORU_001_NODES, ...CHAPTER_MORU_001_PART2_NODES, ...CHAPTER_MORU_002_NODES, ...CHAPTER_MORU_003_NODES, ...CHAPTER_MORU_004_NODES];
