...
export const FRAMEWORK_FACTIONS: FactionBlueprint[] = [
  {
    ...
    winPath: '以主议护持与议势推进稳压取胜',
    passive: '你每回合第一次在主议打出明辩时，该牌+0/+1。',
    weakness: '爆发不足，旁议反应偏弱',
  ...
  },
  {
    ...
    passive: '每当昼夜切换时，你可令一个友军移位或恢复1学识。',
    weakness: '正面终结慢，主议硬碰偏弱',
  ...
  },
  {
    ...
    winPath: '通过惩罚规则与主议税制锁住对手',
    passive: '对手每回合第一次在主议使用术牌时，额外支付1心印。',
    weakness: '铺场慢，旁议经营差',
    hooks: ['OnJudgement', 'OnTopicGain'],
    stage: '首发核心',
  },
  {
    ...
    winPath: '靠旁议构筑、工造衍生与防线滚雪球',
    passive: '你在旁议召唤的衍生物额外+0/+1。',
    weakness: '机动性差，怕移位拆阵',
  ...
  },
  {
    ...
    persona: '先手·稳态·单路·场面',
    routePreference: '左 > 中 > 右',
    winPath: '旁议经营、衍生铺场、后续自然溢出到主议',
    passive: '你控制旁议结束回合时，额外获得1点灵势或恢复1个衍生物1学识。',
    weakness: '怕清场和高爆发旁议偷袭',
  ...
  },
  {
    ...
    passive: '每当昼夜切换时，观星1；若你控制旁议，再得1机变。',
    weakness: '前期场面虚，怕快攻',
    hooks: ['OnCycleChange', 'OnResonanceGain'],
    stage: '第二批',
  },
  ...
  },
  {
    ...
    passive: '你每回合第一次恢复友军学识时，额外抽1后弃1。',
