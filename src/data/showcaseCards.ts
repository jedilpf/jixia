...
export const CARDS: CardData[] = [
    ...
    { id: 'rujia4', name: '仁者无敌', faction: '礼心殿', type: '立论', rarity: '史诗', cost: 4, background: '仁不可夺，位不可撼。厚德载物，故能无敌于天下。', skill: '获得【护持8】；在本回合内，你每使用一张本门派牌，额外获得【护持2】。' },
    { id: 'rujia5', name: '克己复礼', faction: '礼心殿', type: '策术', rarity: '稀有', cost: 2, background: '非礼勿视，非礼勿听。内收其心，外全其礼。', skill: '反制正在结算的1张牌；使你下一次使用的立论降低1费。' },
    { id: 'rujia6', name: '大学之道', faction: '礼心殿', type: '玄章', rarity: '传说', cost: 5, background: '大学之道，在明明德，在亲民，在止于至善。', skill: '场地：你每回合第1次抽牌时，额外抽1；你每获得学识，回复2点底蕴。' },
    { id: 'rujia7', name: '浩然正气', faction: '礼心殿', type: '策术', rarity: '传说', cost: 6, background: '至大至刚，以直养而无害，则塞于天地之间。', skill: '在本回合内，你造成的伤害+5，且你的所有【立论】牌具备【穿透】效果。' },
    { id: 'rujia8', name: '温良恭俭让', faction: '礼心殿', type: '立论', rarity: '史诗', cost: 3, background: '夫子温良恭俭让以得之。和而不流，强哉矫。', skill: '选择2项：抽1；回复3点底蕴；获得【护持3】；净化1个负面状态。' },
    { id: 'rujia9', name: '修齐治平', faction: '礼心殿', type: '玄章', rarity: '传说', cost: 4, background: '修身齐家，治国平天下。层层递进，方为大才。', skill: '场地：战斗开始时你所有属性+1；你每回合结束时，若手牌不少于5张，获得【学识+1】。' },
    { id: 'rujia10', name: '至圣先师', faction: '礼心殿', type: '门客', rarity: '传说', cost: 8, attack: 6, hp: 10, background: '万世师表，木铎一心。其言既出，百家皆静。', skill: '登场：将敌方所有牌洗回其牌库；被动：该角色在场时，敌方每回合只能使用1张牌。' },
    ...
    { id: 'fajia4', name: '严刑峻法', faction: '衡戒廷', type: '策术', rarity: '史诗', cost: 3, background: '罪无大小，皆以律定。雷霆之下，孰敢不从？', skill: '对敌方单体造成3点伤害；若其费用大于等于4，额外造成4点伤害。' },
    { id: 'fajia5', name: '驭下之术', faction: '衡戒廷', type: '策术', rarity: '传说', cost: 4, background: '两手抓利，两手抓害。臣如御马，全在衔勒之间。', skill: '控制敌方随机一名【门客】，直到其被击败或该回合结束。' },
    { id: 'fajia6', name: '秦律森严', faction: '衡戒廷', type: '玄章', rarity: '传说', cost: 5, background: '网疏而不漏，律严而不曲。人在网中，如在瓮中。', skill: '场地：敌方每使用一张牌，受到1点伤害且必须弃掉一张手牌（随机）。' },
    { id: 'fajia7', name: '赏罚分明', faction: '衡戒廷', type: '立论', rarity: '史诗', cost: 3, background: '信赏必罚，则群臣不懈。定轻重之分，见君主之威。', skill: '抽2；若你上回合有牌被反制，下两回合造成的伤害加倍。' },
    { id: 'fajia8', name: '以理服法', faction: '衡戒廷', type: '反诘', rarity: '稀有', cost: 2, background: '法即是理，辩即是刑。公义之下，不容巧言。', skill: '反制正在结算的1张牌；成功后吸收该牌的部分效果（抽牌或伤害）。' },
    { id: 'fajia9', name: '万世法案', faction: '衡戒廷', type: '玄章', rarity: '传说', cost: 6, background: '法之大者，长治久安。一案之下，百世无忧。', skill: '场地：你受到的所有伤害减半（向上取整）；你的所有【反诘】牌费用减少1。' },
    { id: 'fajia10', name: '申韩宗师', faction: '衡戒廷', type: '门客', rarity: '传说', cost: 7, attack: 5, hp: 8, background: '刻薄寡恩，术法之巅。言出法随，莫敢不从。', skill: '登场：令对手所有手牌费用增加2点；被动：你每次造成伤害，对手减少1点底蕴上限。' },
];
